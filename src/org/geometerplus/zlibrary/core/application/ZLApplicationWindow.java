...
abstract public class ZLApplicationWindow {
	...
	abstract protected void scrollViewTo(ZLView.PageObsolete viewPage, int shift);
	abstract protected void startViewAutoScrolling(ZLView.PageObsolete viewPage);
